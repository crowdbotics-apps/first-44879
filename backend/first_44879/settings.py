"""
Django settings for first_44879 project.
...
WSGI_APPLICATION = "first_44879.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "first_44879 API",
    "DESCRIPTION": "API documentation for first_44879 App",
    "VERSION": "v1",
}
